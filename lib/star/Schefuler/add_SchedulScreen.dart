            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: '제목',
                  labelStyle: TextStyle(color: Colors.blueGrey[700]), // 입력 필드 레이블 색상 설정
              ...
              DropdownButtonFormField<String>(
                ...
                items: <String>[
                  '기념일', '생일', '연애 시작일', '결혼 기념일', '첫 만남 기념일',
                  '첫 데이트 기념일', '프로포즈 기념일', '졸업 기념일', '입학 기념일',
                  '취업 기념일', '특별한 날', '휴가 시작일', '이사 기념일', '기타 기념일'
              ...
              SizedBox(height: 16),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween, // 수평 방향으로 위젯을 양 끝에 배치
                children: [
                  Text(
                    '홈화면 표시', // 표시할 텍스트
