...
import 'package:shared_preferences/shared_preferences.dart'; // 세션 사용을 위한 패키지
...
void main() async {
  ...
  // Firebase Authentication을 사용하여 익명 사용자로 로그인합니다.
  await FirebaseAuth.instance.signInAnonymously(); // 익명 사용자로 로그인합니다.

  // SharedPreferences를 초기화합니다. (로컬 데이터 저장을 위한 설정)
...
class Customer extends StatelessWidget {
  const Customer({Key? key}) : super(key: key); // 생성자에서 선택적으로 key를 전달받을 수 있습니다.
